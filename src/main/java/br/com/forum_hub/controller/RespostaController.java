...
public class RespostaController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<DadosListagemResposta> marcarComoSolucao(@PathVariable Long id, @AuthenticationPrincipal Usuario usuario){
        var resposta = service.marcarComoSolucao(id, usuario);
        return ResponseEntity.ok(new DadosListagemResposta(resposta));
    }
